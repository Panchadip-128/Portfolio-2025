...
const TopWrapper = styled.div`
  background: linear-gradient(180deg, rgba(40, 48, 138, 1) 0%, rgba(5, 5, 10, 1) 100%);
  width: 100%;
  clip-path: polygon(0 0, 100% 0, 100% 100%, 30% calc(100% - 50px), 0 100%);
  padding-bottom: 20px;
  position: relative;
  margin-top: -500px;
  padding-top: 300px;
...
const BottomWrapper = styled.div`
  background: linear-gradient(180deg, rgba(30, 26, 43, 1) 0%, rgba(12, 10, 20, 1) 100%);
  width: 100%;
  clip-path: polygon(0 0, 100% 0, 100% calc(100% - 50px), 30% 100%, 0 calc(100% - 50px));
  padding-bottom: 80px;
`
